...
#define SWIGV8_INIT unitized_initialize




#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_unitized_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
  static void _wrap_unitized_set(v8::Local<v8::Name> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#endif
    SWIGV8_HANDLESCOPE();
    ...
    
    {
      ...
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "unitized_set" "', argument " "1"" of type '" "namespace""'"); 
      }  
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "unitized_set" "', argument " "1"" of type '" "namespace""'");
      } else {
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_unitized_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_unitized_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#endif
{
  ...
  SWIGV8_AddStaticVariable(exports_obj, "unitized", _wrap_unitized_get, _wrap_unitized_set);
...
NODE_MODULE(unitized, unitized_initialize)
#endif
